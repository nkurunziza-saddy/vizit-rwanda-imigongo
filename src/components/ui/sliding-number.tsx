...
function Digit({
	...
	return (
		<div
			className={cn(
				"relative inline-block w-[1ch] overflow-x-visible overflow-y-clip leading-none tabular-nums font-mono",
				className,
			)}
		>
...
export function SlidingNumber({
	...
	return (
		<div
			className={cn("flex items-center font-mono text-foreground", className)}
		>
			{value < 0 && "-"}
