            ...
            >
              <div className="sticky top-28 bg-card rounded-2xl border border-border shadow-card p-6">
                ...
                <div className="grid grid-cols-2 gap-2 mb-4">
                  <Popover>
                    <PopoverTrigger render={<button className="text-left p-3 border border-border rounded-xl hover:border-primary transition-colors"/>}>
                ...
                {/* Reserve Button */}
                <Button variant="default" size="lg" className="w-full rounded-xl mb-4">
                  Reserve
                </Button>
