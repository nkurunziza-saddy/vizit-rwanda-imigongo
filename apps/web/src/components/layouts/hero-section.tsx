...
import { TicketSelectionModal } from "@/components/booking/ticket-modal";
  ...
  return (
    <div className="relative min-h-[600px] flex items-center justify-center overflow-hidden py-24 md:py-32">
      ...
      <div className="container relative z-10 mx-auto px-4 text-center max-w-5xl">
        <h1 className="text-xl md:text-3xl font-extrabold tracking-tight text-foreground mb-6">
          Discover <span className="text-primary">Rwanda</span>
        </h1>
        <p className="mt-4 text-lg text-muted-foreground mb-12 max-w-lg mx-auto">
          Experience the land of a thousand hills. Find unique stays, premium
          cars, and expert guides for your journey.
        </p>
          ...
          <div className="flex flex-col md:flex-row items-center gap-2">
            ...
            <div className="w-full md:w-auto p-1">
              <Button
                ...
                size="lg"
                className="w-full md:w-auto rounded-full h-12 px-8 gap-2 shadow-md"
              >
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-4 text-sm text-muted-foreground">
          ...
          <Link
            ...
            className="hover:text-primary transition-colors cursor-pointer px-3 py-1 rounded-full border border-transparent hover:border-border hover:bg-secondary/30"
          >
            Hotels
          </Link>
          <Link
